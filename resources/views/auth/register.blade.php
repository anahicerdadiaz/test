                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                              ...
                              <!--FIN prueba de ojito en contraseña-->     
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group-append">
                                    <button id="show_password" class="btn btn-primary" type="button" onclick="mostrarPasswordConfirmacion()"><i class="fa fa-eye-slash icon2"></i></button>
                                    </div>
                                    </div>
                              <!--FIN prueba de ojito en contraseña-->  
                            </div>
